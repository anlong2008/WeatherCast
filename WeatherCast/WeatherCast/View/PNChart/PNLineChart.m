...
-(void)strokeChart
{
    ...
    [self drawAPoint:CGPointMake(index * xPosition + 30.0 + _xLabelWidth /2.0, chartCavanHeight - grade * chartCavanHeight + 20.0 ) color:[UIColor redColor] radius:5.0f];
...
- (void)drawAPoint:(CGPoint)point color:(UIColor *)color radius:(CGFloat)radius {
